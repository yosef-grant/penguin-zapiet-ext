...
${errorInfo.componentStack}`);
  ...
  // extensions/lolas-thank-you-extension/src/helpers/Currency.jsx
  var currency = (value) => {
    const currencyFormat = (x2) => {
      let formattedInt = new Intl.NumberFormat("en-GP", {
        style: "currency",
        currency: "GBP"
      }).format(parseFloat(x2) / 100);
      return formattedInt;
    };
  ...
  // extensions/lolas-thank-you-extension/src/Components/LoveClub/LoveClub.jsx
  var import_jsx_runtime4 = __toESM(require_jsx_runtime());
  var LCIcon = "https://cdn.shopify.com/s/files/1/0575/1468/8647/files/LoveClubThankYouIcon.svg?v=1709720886";
  var LoveClub = () => {
    const appMeta = useAppMetafields();
    const customer = useCustomer();
    const points = customer && appMeta ? parseInt(
      appMeta.filter((meta) => meta.target.type === "customer").map((filteredMeta) => filteredMeta.metafield.value)[0]
    ) : null;
    console.log(
    ...
    return customer && points ? /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(View2, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Divider2, { size: "base" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
        InlineLayout2,
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Image2, { source: LCIcon }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
              BlockLayout2,
              {
                ...
                rows: "auto",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { emphasis: "bold", children: "Your Love Club points" }),
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
                    InlineLayout2,
                    {
                      spacing: "tight",
                      ...
                      blockAlignment: "center",
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { emphasis: "bold", size: "large", children: points }),
                        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: `(${Currency_default(points)})` })
                      ]
                    }
                  )
                ]
  ...
  var LoveClub_default = LoveClub;

  // extensions/lolas-thank-you-extension/src/Components/ThankYouLineItemProps/ThankYouLineItemProps.jsx
  var import_react26 = __toESM(require_react());
  var import_jsx_runtime5 = __toESM(require_jsx_runtime());
  var ThankYouLineItemProps = () => {
    const currentItem = useCartLineTarget();
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: currentItem.attributes.map((attribute) => {
      return attribute.key === "_Personalisation Message" && attribute.value ? /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Text2, { emphasis: "bold", size: "small", children: [
          "Personalised Message:",
          " "
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { size: "small", children: attribute.value })
      ] }) : null;
    }) });
  };
  var ThankYouLineItemProps_default = ThankYouLineItemProps;

  // extensions/lolas-thank-you-extension/src/Components/MainBody/MainBody.jsx
  var import_react29 = __toESM(require_react());

  // extensions/lolas-thank-you-extension/src/Components/MainBody/AccountCreate.jsx
  var import_react27 = __toESM(require_react());
  var import_jsx_runtime6 = __toESM(require_jsx_runtime());
  var AccountCreate = ({ shippingAddress, email, url: url2 }) => {
    const [pw, setPW] = (0, import_react27.useState)(null);
    const [error, setError] = (0, import_react27.useState)(false);
    const [complete, setComplete] = (0, import_react27.useState)({});
    ...
    const handleSubmit = () => __async(void 0, null, function* () {
      ...
      if (!!pw) {
        let res = yield fetch(`${url2}/pza/checkout-account-create`, {
          headers: {
        ...
        if (!data.account_created) {
          ...
          data.error ? setComplete({ status: true, errors: true }) : setComplete({ status: true, errors: false });
        }
        console.log(data);
        setFetching(false);
      }
    });
    return !customer ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Divider2, { size: "base" }),
      (complete == null ? void 0 : complete.status) ? complete.errors ? /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_jsx_runtime6.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Text2, { children: "An account with this email already exists." }) }) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_jsx_runtime6.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(Text2, { children: [
        "Your account has been created! A confirmation email has been sent to ",
        email,
        "."
      ] }) }) : /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_jsx_runtime6.Fragment, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Heading2, { children: "CREATE A PASSWORD" }),
        /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(BlockStack2, { children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(Text2, { children: [
          "Create an account by adding a password below and collect your",
          " ",
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Text2, { emphasis: "bold", children: "Love Clube points" }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(Form2, { onSubmit: () => handleSubmit(), children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Button2, { accessibilityRole: "submit", loading: fetching, children: "CREATE" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(View2, { children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(
            Text2,
            {
              size: "small",
              emphasis: error ? "bold" : "",
              appearance: error ? "warning" : "",
              children: "Minimum 8 characters, including 1 numerical character (0-9)"
            }
          ) })
        ] }) })
      ] })
  ...
  var AccountCreate_default = AccountCreate;
  ...
  // extensions/lolas-thank-you-extension/src/Components/MainBody/Survey.jsx
  var import_react28 = __toESM(require_react());
  var import_jsx_runtime7 = __toESM(require_jsx_runtime());
  var ratingVals = ["1", "2", "3", "4", "5"];
  var Survey = ({ url: url2, email, shippingAddress }) => {
    const [rating, setRating] = (0, import_react28.useState)("3");
    const [feedback, setFeeback] = (0, import_react28.useState)(null);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(View2, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Heading2, { children: "How was your online shopping experience?" }),
      !submitted ? /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(Form2, { onSubmit: () => handleSubmit(), children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
          ChoiceList2,
          {
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(InlineStack2, { padding: ["base", "none", "base", "none"], children: ratingVals.map((val, i2, arr) => /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
              BlockLayout,
              {
                ...
                rows: ["fill", "fill", "fill"],
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(View2, { minInlineSize: 50, inlineAlignment: "center", children: i2 === 0 ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Text2, { children: "Bad" }) : i2 === arr.length - 1 ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Text2, { children: "Good" }) : null }),
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Choice2, { id: val }),
                  /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Text2, { children: val })
                ]
              }
            )) })
          }
        ),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(View2, { children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
          TextField2,
          {
            label: "Any thoughts?",
            multiline: 5,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Button2, { accessibilityRole: "submit", loading, children: "Submit" })
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Text2, { children: "Thank you for your feedback!" })
    ] });
  };
  ...
  var MainBody = ({ url: url2 }) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(View2, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(AccountCreate_default, { shippingAddress, email, url: url2 }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Divider2, { size: "base" }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Survey_default, { url: url2, email, shippingAddress })
    ] });
  };
  ...
  var url = "https://levitra-mortgages-skin-bags.trycloudflare.com/";
  ...
  var ThankYouLineItemPropsExt = reactExtension(
    ...
    () => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(ThankYouLineItemProps_default, {})
  );
  var LoveClubExt = reactExtension(
    "purchase.thank-you.cart-line-list.render-after",
    () => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(LoveClub_default, {})
  );
})();
