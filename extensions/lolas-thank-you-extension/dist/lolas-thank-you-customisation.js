...
${errorInfo.componentStack}`);
  ...
  // extensions/lolas-thank-you-customisation/src/Components/LoveClub/LoveClub.jsx
  var import_jsx_runtime4 = __toESM(require_jsx_runtime());
  var LoveClub = () => {
    const appMeta = useAppMetafields();
    console.log("this is app meta from loveclub: ", appMeta);
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Text2, { children: [
      "Your points balance:",
      " ",
      parseInt(
  ...
  // extensions/lolas-thank-you-customisation/src/Components/ThankYouLineItemProps/ThankYouLineItemProps.jsx
  var import_jsx_runtime5 = __toESM(require_jsx_runtime());
  function ThankYouLineItemProps() {
    const translate = useTranslate();
    const { extension: extension2 } = useApi();
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Banner2, { title: "Thank You Summary", children: translate("welcome", { target: extension2.target }) });
  }
  var ThankYouLineItemProps_default = ThankYouLineItemProps;

  // extensions/lolas-thank-you-customisation/src/App.jsx
  var import_jsx_runtime6 = __toESM(require_jsx_runtime());
  var ThankYouLineItemPropsExt = reactExtension(
    "purchase.thank-you.cart-line-item.render-after",
    () => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(ThankYouLineItemProps_default, {})
  );
  var LoveClubExt = reactExtension(
    "purchase.thank-you.cart-line-list.render-after",
    () => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(LoveClub_default, {})
  );
})();
//# sourceMappingURL=lolas-thank-you-customisation.js.map
