...
${errorInfo.componentStack}`);
  ...
  var OpeningHours = ({ locationHours, locationDescription, currentDate }) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
      InlineLayout2,
      {
        ...
        spacing: "loose",
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(View2, { padding: ["none", "none", "none", "tight"], children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { children: "Opening Hours" }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { padding: ["extraTight", "none", "none", "none"], children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockLayout2, { children: weekdays.map((weekday, i2) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { position: "relative", children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
              InlineLayout2,
              {
                spacing: "extraTight",
                ...
                inlineAlignment: "end",
                children: [
                  format(new Date(currentDate), "EEEE") === weekday && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                    View2,
                    {
                      position: {
                        type: "absolute",
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                    Text2,
                    {
                      size: "base",
                      emphasis: "bold",
                      appearance: format(new Date(currentDate), "EEEE") === weekday ? "accent" : "",
                      children: `${weekday.slice(0, 3)}: `
                    }
                  ),
                  /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                    Text2,
  ...
  var Calendar = ({
    ...
    const [today, setToday] = (0, import_react28.useState)(/* @__PURE__ */ new Date());
    const [backwardLocked, setBackwardLocked] = (0, import_react28.useState)(false);
    const [forwardLocked, setForwardLocked] = (0, import_react28.useState)(false);
    const [selected, setSelected] = (0, import_react28.useState)(null);
    const [selectedMonth, setSelectedMonth] = (0, import_react28.useState)(null);
    const [pickupTimes, setPickupTimes] = (0, import_react28.useState)(null);
    const [currentHover, setCurrentHover] = (0, import_react28.useState)(null);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(View2, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(InlineLayout2, { blockAlignment: "center", columns: ["auto", "fill"], children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(BlockStack2, { spacing: "extraTight", children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Heading2, { level: 1, children: getHeading() }),
          selectedMethod === "pickup" ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { size: "base", children: attributes["Pickup-Location-Company"].replaceAll(/\s-\s/gm, " ") }) : /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(Text2, { children: [
            formatDeliveryType(),
            " to ",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
        InlineStack2,
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Pressable2, { onPress: () => weekBack(), children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Icon2, { source: "arrowLeft" }) }),
            ...
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Pressable2, { onPress: () => weekForward(), children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Icon2, { source: "arrowRight", onPress: () => weekForward() }) })
          ]
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
          ...
          children: [
            ...
            days.map((day, i2) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
              View2,
              {
                ...
                inlineSize: "fill",
                children: !selected && format(new Date(addDays(today, i2)), dateFormat) === minDate || selected && selected === format(new Date(addDays(today, i2)), dateFormat) ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                  InlineLayout2,
                  {
                    minInlineSize: 70,
                    minBlockSize: 50,
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                      Button2,
                      {
                        disabled: isDateDisabled(
                          format(addDays(today, i2), dateFormat)
                        ),
                        onPress: () => setSelectedDate(
                          format(new Date(addDays(today, i2)), dateFormat)
                        ),
                        children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { children: format(addDays(today, i2), "d").toString() })
                      }
                    )
                  }
                ) : /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(InlineLayout2, { minInlineSize: `${50}%`, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                  Pressable2,
                  {
                    minInlineSize: 70,
                    minBlockSize: 50,
      ...
      selectedMethod === "pickup" && attributes["Pickup-Location-Id"] && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(View2, { padding: ["base", "none", "tight", "none"], children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(TextBlock2, { children: [
          ...
          " ",
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { emphasis: "bold", children: getPickupTime(selected ? selected : minDate, "pm") }),
          ", otherwise your order will be available from",
          " ",
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { emphasis: "bold", children: getPickupTime(selected ? selected : minDate, "am") })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
  ...
  var DeliveryTypeSelect = ({
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(View2, { padding: ["none", "none", "base", "none"], children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(View2, { padding: ["none", "none", "base", "none"], children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(Heading2, { children: "Select delivery type:" }) }),
  ...
  var BlockLoader = ({ message }) => {
    return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(View2, { position: "relative", children: [
      /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(SkeletonImage, { blockSize: 50, inlineSize: "fill", aspectRatio: 2 }),
      /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
        View2,
        {
          ...
          blockAlignment: "center",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(View2, { maxBlockSize: 75, maxInlineSize: 75, padding: ["none", "none", "tight", "none"], children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Spinner2, { size: "fill", accessibilityLabel: message }) }),
            /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(Text2, { size: "medium", children: message })
          ]
        }
      )
    ] });
  ...
  var DateSelect = ({
    ...
    const [fetching, setFetching] = (0, import_react31.useState)(true);
    const [minDate, setMinDate] = (0, import_react31.useState)(null);
    const [blackoutDates, setBlackoutDates] = (0, import_react31.useState)(null);
    const [locationHours, setLocationHours] = (0, import_react31.useState)(null);
    const [locationDescription, setLocationDescription] = (0, import_react31.useState)(null);
    const [deliveryType, setDeliveryType] = (0, import_react31.useState)(null);
    const [deliveryData, setDeliveryData] = (0, import_react31.useState)(null);
    const [currentDeliveryPostcode, setCurrentDeliveryPostcode] = (0, import_react31.useState)(null);
    const [currentPickupLocationId, setCurrentPickupLocationId] = (0, import_react31.useState)(null);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(import_jsx_runtime8.Fragment, { children: fetching ? /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
      ...
      /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
        selectedMethod !== "pickup" && deliveryData && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(
  ...
  var DatePicker_default = reactExtension(
    ...
    () => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(DatePicker, {})
  );
  function DatePicker() {
    const selectedMethod = useAttributeValues(["Checkout-Method"])[0];
    const changeAttributes = useApplyAttributeChange();
    const [locationId, setLocationId] = (0, import_react32.useState)(null);
    const [locationType, setLocationType] = (0, import_react32.useState)(null);
    const [locationHandle, setLocationHandle] = (0, import_react32.useState)(null);
    const [availableMethods, setAvailableMethods] = (0, import_react32.useState)(null);
