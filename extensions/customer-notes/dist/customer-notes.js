...
${errorInfo.componentStack}`);
  ...
  // extensions/customer-notes/src/CustomerNotes.jsx
  var import_react15 = __toESM(require_react());
  var import_jsx_runtime4 = __toESM(require_jsx_runtime());
  var CustomerNotes_default = reactExtension(
    "purchase.checkout.shipping-option-list.render-before",
    () => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(DeliveryInstructions, {})
  );
  var DeliveryInstructions = () => {
    ...
    const [gNoteVisible, setGNoteVisible] = (0, import_react15.useState)(
      giftNote && giftNote !== "" ? true : false
    );
    const handleNoteChange = (val) => __async(void 0, null, function* () {
    ...
    const handleNoteInput = (val) => __async(void 0, null, function* () {
      if (!val && currentNote) {
        yield changeNote({
          type: "removeNote"
        });
    ...
    const handleChkbxChange = () => __async(void 0, null, function* () {
    ...
    const handleMessageChange = (val) => __async(void 0, null, function* () {
      yield changeAttr({
        type: "updateAttribute",
        key: "Gift-Note",
        value: val
    ...
    const handleMessageInput = (val) => __async(void 0, null, function* () {
      if (!val && giftNote) {
        yield changeAttr({
          type: "updateAttribute",
          key: "Gift-Note",
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
      currentMethod !== "pickup" && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        TextField2,
        {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
        View2,
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { level: 1, children: "Gift Note" }),
            /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { padding: ["tight", "none", "extraTight", "none"], children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockLayout2, { spacing: "base", rows: ["auto", "auto"], children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Checkbox2, { onChange: () => handleChkbxChange(), value: gNoteVisible, children: "Add a free gift note" }),
              gNoteVisible && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
                TextField2,
                {
