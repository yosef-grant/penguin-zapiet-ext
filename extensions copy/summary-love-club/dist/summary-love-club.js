...
${errorInfo.componentStack}`);
  ...
  // extensions/summary-love-club/src/LoveClub.jsx
  var import_jsx_runtime4 = __toESM(require_jsx_runtime());
  var LoveClub_default = reactExtension(
  ...
  function Extension() {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(View2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Text2, { children: [
      "Your points balance: ",
      parseInt(appMeta.filter((meta) => meta.target.type === "customer").map((filteredMeta) => filteredMeta.metafield.value)[0])
    ] }) });
  }
})();
