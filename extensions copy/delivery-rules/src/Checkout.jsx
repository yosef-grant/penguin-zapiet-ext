...
const RatesRender = reactExtension(
  "purchase.checkout.shipping-option-list.render-before",
  () => <Extension />
);

export { MethodSelectRender, RatesRender };
...
function Extension() {
  ...
  const app_url =
    "https://administrators-wr-steam-canvas.trycloudflare.com/";
  ...
  return (
    <>
      ...
      "purchase.checkout.shipping-option-list.render-before" ? (
        <>
          This is a test for the date picker. Test state: {testState}
          <Button  onPress={() => setTestState(testState+ 1)}>Increment state</Button>
