...
${errorInfo.componentStack}`);
  ...
  var Locations = ({
    ...
    const [selectedPickupLocation, setSelectedPickupLocation] = (0, import_react33.useState)(null);
    ...
    const [postcodeFetching, setPostcodeFetching] = (0, import_react33.useState)(false);
    ...
    (0, import_react33.useEffect)(() => {
      ...
      const revertShippingAddress = () => __async(void 0, null, function* () {
        console.log(
          "from revert: ",
          JSON.stringify(selectedLocation),
          JSON.stringify(currentShippingAddress)
        );
        JSON.stringify(selectedLocation) !== JSON.stringify(currentShippingAddress) ? yield changeShippingAddress({
          type: "updateShippingAddress",
          address: {
      ...
      if (selectedLocation === null && attributes["Checkout-Method"] === "pickup") {
        resetShippingAddress();
      } else if (selectedLocation !== null && attributes["Checkout-Method"] === "pickup") {
    ...
    const handleChange = (val, type) => __async(void 0, null, function* () {
      ...
      if (type === "location") {
        ...
        if (val.length < 12 && val.length > 0 && (!searchPostcodeQuery || val.toLowerCase().replace(/\s/, "") !== searchPostcodeQuery.toLowerCase().replace(/\s/, ""))) {
    ...
    const handleInput = (val, type) => {
      if (type === "location") {
        searchLocationQuery && !val ? (removeLocation(), setSearchPostcodeQuery(null), setSearchLocationQuery(null)) : setSearchLocationQuery(val);
    ...
    (0, import_react33.useEffect)(() => {
      ...
      if (searchLocationQuery) {
        ...
        unfiltered.forEach((location) => {
          location.company_name.toLowerCase().includes(searchLocationQuery.toLowerCase()) ? x.push(location) : null;
        });
    ...
    const getShippingRates = () => __async(void 0, null, function* () {
      ...
      let y = yield fetch("https://intuitiveshipping.io/rating", requestOptions);
      console.log(y);
    });
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Form2, { onSubmit: () => console.log("form submitted!"), children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
        InlineLayout,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Divider2, { direction: "block" }),
            /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(View2, { children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(InlineLayout, { spacing: "extraTight", columns: ["fill", 45], children: [
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                TextField2,
                {
              ...
              /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                Button2,
                {
                  ...
                  children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Icon2, { source: "magnify" })
                }
              )
            ] }) })
          ]
        ...
        ScrollView2,
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
            ChoiceList2,
            {
              ...
              variant: "group",
              children: filteredLocations.map((location, i) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
                Choice2,
                {
                  disabled: postcodeFetching ? true : false,
                  id: `${location.id}`,
                  ...
                  details: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
                    InlineLayout,
                    {
                      ...
                      children: [
                        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(View2, { padding: ["none", "none", "none", "tight"], children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(View2, { padding: ["extraTight", "none", "none", "none"], children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(BlockLayout2, { children: weekdays.map((weekday, i2) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(View2, { position: "relative", children: /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
                            InlineLayout,
                            {
                              spacing: "extraTight",
                              blockAlignment: "center",
                              ...
                              children: [
                                ...
                                /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Text2, { size: "base", children: `${location.meta_hours[`${weekday.toLowerCase()}_opening_hours`]} 
                            ` })
                              ]
                            }
                          ) }, `${weekday}${i2}`)) }) })
                        ...
                        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(View2, { children: [
                          ...
                          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(TextBlock2, { children: location.meta_description })
                        ] })
                      ]
                    }
                  ),
  ...
  var CSPortal = ({ setCS, cs, allLocations }) => {
    ...
    const handleFormSubmit = () => __async(void 0, null, function* () {
      let x = (cs == null ? void 0 : cs.location) && (cs == null ? void 0 : cs.name) ? `${cs.location.company_name}: ${cs.name}` : (cs == null ? void 0 : cs.location) ? cs.location.company_name : cs.name;
      yield changeAttributes({
        type: "updateAttribute",
        key: "Lolas-CS-Member",
        value: x
  ...
  var checkoutDataReducer = (checkoutData, action) => {
    ...
    switch (action.type) {
      ...
      case "selected_pickup_location_added": {
        (x == null ? void 0 : x.delivery) ? null : x.qCollect = true;
        x.pickup = __spreadProps(__spreadValues({}, x.pickup), {
          selectedLocation: {
      ...
      case "selected_pickup_location_confirmed": {
        x.pickup = __spreadProps(__spreadValues({}, x.pickup), {
          selectedLocation: __spreadProps(__spreadValues({}, x.pickup.selectedLocation), {
  ...
  var MethodSelect = ({
    ...
    const [methodHover, setMethodHover] = (0, import_react40.useState)(false);
    return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
        InlineLayout2,
        {
          ...
          children: attributes["Checkout-Method"] === "pickup" ? /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Button2, { children: "Collection" }),
            /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
              Pressable2,
              {
                inlineAlignment: "center",
                ...
                onPress: attributes["Checkout-Method"] !== "delivery" ? () => handleMethodSelect("delivery", availableMethods) : null,
            ...
            /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
              Pressable2,
              {
                ...
                border: "base",
                background: methodHover ? "subdued" : "transparent",
                onPress: attributes["Checkout-Method"] !== "pickup" ? () => handleMethodSelect("pickup", availableMethods) : null,
                children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Text2, { size: "medium", emphasis: "bold", children: "Collection" })
              }
            ),
            /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Button2, { children: "Delivery" })
          ] })
        }
      ),
      ...
      ] }) : attributes["Checkout-Method"] !== "pickup" ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
        View2,
        {
          padding: ["tight", "none", "none", "none"],
          inlineAlignment: "center",
          children: !!showDeliveryError || !!noDelivery ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
            View2,
            {
              minInlineSize: "fill",
              padding: ["tight", "none", "none", "none"],
              children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Banner2, { status: "warning", children: /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(Text2, { size: "base", emphasis: "bold", children: [
                "Delivery is not available for this address. Try an alternative address or",
                " ",
                /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(
                  Button2,
                  {
                    ...
                    children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Text2, { children: "switch to collection" })
                  }
                )
              ] }) })
            }
          ) : /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_jsx_runtime12.Fragment, { children: !checkingPostcode ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(import_jsx_runtime12.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Text2, { emphasis: "bold", size: "base", children: "Enter delivery address below" }) }) : /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
            /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Text2, { emphasis: "bold", size: "base", children: "Checking address..." }),
            /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(View2, { padding: ["tight", "none", "none", "none"], children: /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(Spinner2, {}) })
          ] }) })
        }
      ) : null
    ] });
  ...
  // extensions/delivery-rules/src/ScrollListTest.jsx
  ...
  var MethodSelectRender = reactExtension(
    ...
    () => /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(Extension, {})
  );
  var RatesRender = reactExtension(
    "purchase.checkout.shipping-option-list.render-before",
    () => /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(Extension, {})
  );
  function Extension() {
    const app_url = "https://administrators-wr-steam-canvas.trycloudflare.com/";
    ...
    const [loadMsg, setLoadMsg] = (0, import_react45.useState)("Initialising...");
    const [storedAvailibility, setStoredAvailibility] = (0, import_react45.useState)(null);
    const [datePickerInit, setDatePickerInit] = (0, import_react45.useState)(false);
    const [checkingPostcode, setCheckingPostcode] = (0, import_react45.useState)(false);
    const [noDelivery, setNoDelivery] = (0, import_react45.useState)(false);
    const [showDeliveryError, setShowDeliveryError] = (0, import_react45.useState)(false);
    const [cs, setCS] = (0, import_react45.useState)({ status: false });
    const [initLoad, setInitLoad] = (0, import_react45.useState)(true);
    const [testState, setTestState] = (0, import_react45.useState)(0);
    ...
    let nextDayMeta = appMeta.filter((meta) => meta.target.type === "product").map((filteredMeta) => {
      JSON.parse(filteredMeta.metafield.value).next_day_delivery.value;
    });
    console.log("next day meta ", nextDayMeta);
    ...
    const handleMethodSelect = (method, availabilityData) => __async(this, null, function* () {
      let x = Object.keys(availabilityData).filter((key) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(import_jsx_runtime17.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(Button, { onPress: () => setTestState(testState + 1), children: "Increment state" }),
      extension2.target === "purchase.checkout.contact.render-after" && /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(import_jsx_runtime17.Fragment, { children: [
        "This is the testState: ",
        testState,
        initLoad ? /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(BlockLoader_default, { message: loadMsg }) : /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(import_jsx_runtime17.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
      ...
      extension2.target === "purchase.checkout.shipping-option-list.render-before" ? /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(import_jsx_runtime17.Fragment, { children: [
        "This is a test for the date picker. Test state: ",
        testState,
        /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(Button, { onPress: () => setTestState(testState + 1), children: "Increment state" })
      ] }) : null
    ] });
